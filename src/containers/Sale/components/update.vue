  ...
  <div v-if="!isLoad">
    <div class="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-4">
      <div class="rounded-lg">
        <h1 class="label-big">
          Общие данные
          <span class="cursor-pointer" @click="full = !full">{{
        ...
        <div class="grid-2-2-1 section">
          <div>
            ...
            <div class="tl">
              <field label=" Через ЛК?">{{
                data.EI_FROM_LK ? 'Да' : 'Нет'
              }}</field>
            </div>
      ...
      <div>
        <h1 class="label-big">Состояние</h1>
            ...
            <div>
              ...
              <div class="tl">
                <label class="label-primary"
                  >Ориентировочная дата отгрузки:</label
                >
                <div class="flex justify-between items-center">
                  <flat-pickr
                    class="input-primary"
              ...
              <div class="tl">
                <label class="label-primary"
                  >Отгрузка со склада поставщика?</label
                >
                <div>
      ...
      <!--TRIRD block-->
      <div>
        <h1 class="label-big">Способ доставки для "Мiзол"</h1>
      ...
      <div class="rounded-lg col-span-2 lg:col-span-2 md:col-span-2">
        <h1 class="label-big">
          Налоги и суммы
          <span class="cursor-pointer" @click="ffull = !ffull">{{
            ffull ? '(скрыть)' : '(подробнее)'
          }}</span>
        </h1>
        <div class="grid-2-2-1 section">
          <!--Первый блок-->
      ...
      <div class="col-span-1 lg:col-span-2 md:col-span-2">
        <h1 class="label-big">
          Описание
          <span class="cursor-pointer" @click="afull = !afull">{{
            afull ? '(скрыть)' : '(подробнее)'
          }}</span>
        </h1>
        <div v-show="afull">
          <div class="mx-4 mt-4">
            <label class="block text-base font-medium text-gray-400"></label>
            <div class="mt-1">
      ...
      <div class="rounded-lg col-span-1 lg:col-span-1 md:col-span-1">
        <h1 class="label-big">
          ...
          <span class="cursor-pointer" @click="bfull = !bfull">{{
            bfull ? '(скрыть)' : '(подробнее)'
          }}</span>
        </h1>
        <div class="">
          <!--Первый блок-->
    ...
    <h1 class="label-big mt-4">
      Способы доставки
      <span class="cursor-pointer" @click="cfull = !cfull">{{
        cfull ? '(скрыть)' : '(подробнее)'
      }}</span>
    </h1>
    <div class="w-full flex justify-center mt-6 space-x-2" v-show="cfull">
      <button type="button" class="button-hover-primary-color">
        Адрес - Адрес
      </button>
      <button type="button" class="button-hover-primary-color">
        Адрес - Отделение
      ...
      <button type="button" class="button-hover-primary-active">
        Добавить ТТН
      </button>
    </div>
    <div class="w-full flex justify-center mt-6">
      <button
        @click="update(update_route(data))"
        type="button"
        class="button-hover-primary"
      >
        Изменить
      </button>
    </div>
