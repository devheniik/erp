...
<div class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
            ...
            <li>
                <div class="mt-1 flex rounded-md shadow-sm w-full">
                    <div class="relative flex items-stretch flex-grow focus-within:z-10 w-full">
                        ...
                        <input type="text" name="email" id="email" :value="page" @input="$emit('update:page', $event.target.value)" class="focus:ring-indigo-500 focus:border-indigo-500 block rounded-none rounded-l-md   sm:text-sm border-gray-300 w-full" placeholder="10" />
                    </div>
    ...
    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
        <div class="flex flex-row items-center ">
            <div @click="settings = !settings" class="rounded-sm z-10 relative bg-primary-500  text-secondary-50 hover:bg-primary-600 inline-flex items-center px-2 py-2  text-sm font-medium mr-5 ">
        ...
        <div>
            <nav class="relative z-0 inline-flex rounded-md  shadow-sm space-x-1" aria-label="Pagination">
                <button :disabled="!(page - 1 > 0)" @click="handle(true, -1)" class="relative inline-flex items-center min-w-[34px] px-2 py-2 rounded-sm   bg-white text-sm font-medium text-gray-500 hover:bg-secondary-300"> 
                        <ChevronLeftIcon class="h-4 w-4" />
                    </button>
                <div v-if="page - 2 > 1" @click="handle(false, 1)" aria-current="page" :class="['z-10 relative bg-white  text-gray-500 hover:bg-secondary-300 inline-flex items-center py-2 px-2 min-w-[34px] justify-center rounded-sm   text-sm font-medium']">
                    1
                </div>
                <div v-if="page - 2 > 2" @click="handle(false, 2)" aria-current="page" :class="['z-10 relative bg-white  text-gray-500 hover:bg-secondary-300 inline-flex items-center py-2 px-2 min-w-[34px] justify-center rounded-sm   text-sm font-medium']">
                    2
                </div>
                ...
                <div v-if="page - 2 > 0" @click="handle(true, -2)" aria-current="page" :class="['z-10 relative bg-white  text-gray-500 hover:bg-secondary-300 inline-flex items-center py-2 px-2 min-w-[34px] justify-center rounded-sm   text-sm font-medium']">
                    {{ page - 2 }}
                </div>
                <div v-if="page - 1 > 0" @click="handle(true, -1)" aria-current="page" :class="['z-10 relative bg-white  text-gray-500 hover:bg-secondary-300 inline-flex items-center py-2 px-2 min-w-[34px] justify-center rounded-sm   text-sm font-medium']">
                    {{ page - 1 }}
                </div>
                ...
                <div v-if="page + 1 < pagination.total_pages" @click="handle(true, 1)" class="bg-white  text-gray-500 hover:bg-secondary-300 relative inline-flex items-center py-2 px-2 min-w-[34px] justify-center rounded-sm   text-sm font-medium">
                    {{ page + 1 }}
                </div>
                ...
                <div v-if="pagination.total_pages - 1 > page" @click="handle(false, pagination.total_pages - 1)" class="bg-white  text-gray-500 hover:bg-secondary-300 relative inline-flex items-center py-2 px-2 min-w-[34px] justify-center rounded-sm   text-sm font-medium">
                    {{ pagination.total_pages - 1 }}
                </div>
                <div v-if="pagination.total_pages > page" @click="handle(false, pagination.total_pages)" class="bg-white  text-gray-500 hover:bg-secondary-300 relative inline-flex items-center py-2 px-2 min-w-[34px] justify-center rounded-sm   text-sm font-medium">
                    {{ pagination.total_pages }}
                </div>
                <button :disabled="page + 1 > pagination.total_pages" @click="handle(true, +1)" class="relative inline-flex items-center min-w-[34px] px-2 py-2 rounded-sm   bg-white text-sm font-medium text-gray-500 hover:bg-secondary-300">
