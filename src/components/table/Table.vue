                            ...
                            <table class="w-full divide-y divide-gray-200">
                                <thead class="bg-primary-50 rounded-xl">
                                    <tr>
                                        ...
                                        <th v-for="(header, i) in headers" :key="i" @click="$emit('sort', header.value)" scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
